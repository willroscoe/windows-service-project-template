...
{
    // To Install service (from Developer Command Prompt): installutil.exe $safeprojectname$.exe
    // To Uninstall service (from Developer Command Prompt): installutil.exe /u $safeprojectname$.exe
